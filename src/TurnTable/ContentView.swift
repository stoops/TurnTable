...
extension String {
    func version() -> String { return "1.1.355" }
}
                    ...
                    if (temp != "") { //if let temp = try? exec(cmdl) {
                        ...
                        if (outp != "") {
                            ...
                            while ((iidx < list.count) && (lnum < 5)) {
                                usleep(675000)
                                quel.withLock {
                                    while ((iidx < list.count) && (taba[iidx].path != "")) {
                                        if (taba[iidx].dobj > ldat) {
                                            ldat = taba[iidx].dobj
                                            relo = 1
                                        }
                                        iidx += 1
                                ...
                                lidx = iidx
                                print(Date(),"DEBUG","wait",iidx,lidx,list.count,lnum)
                            }
                            quel.withLock {
                                tabt.removeAll()
                                for item in taba {
            ...
            VStack {
                HStack {
                    VStack {
                        ...
                        let spcv = 1.75
                        HStack {
                            butv(kind:"backward.circle", size:27.0, extr:[epad*spcs, 0.0], iidx:21, clst:["b", "g", "b", "!"], meth:-1, pram:-1, actn:frev, actc:niln).offset(y:0.99)
                            butv(kind:"backward.end.circle", size:37.0, extr:[epad*spcr, 0.0], iidx:0, clst:["b", "g", "b", "!"], meth:-1, pram:-1, actn:prev, actc:niln)
                            butv(kind:plyi(), size:45.0, extr:[epad*spcr, 0.0], iidx:idxs[5], clst:["b", "g", "b", "~"], meth:-1, pram:-1, actn:bply, actc:plyz)
                            butv(kind:"forward.end.circle", size:37.0, extr:[epad*spcr, 0.0], iidx:2, clst:["b", "g", "b", "!"], meth:-1, pram:-1, actn:more, actc:niln)
                            butv(kind:"forward.circle", size:27.0, extr:[epad*spcs, 0.0], iidx:23, clst:["b", "g", "b", "!"], meth:-1, pram:-1, actn:ffwd, actc:niln).offset(y:0.99)
                        }.offset(y:-0.99)
                        HStack {  }.overlay(
                            HStack {
                                butv(kind:muti(), size:24.0, extr:[epad*spcv, 0.0], iidx:75, clst:["b", "g", "b", "~"], meth:-1, pram:-1, actn:minv, actc:mutz)
                                ...
                                butv(kind:"speaker.wave.2.circle", size:24.0, extr:[epad*spcv, 0.0], iidx:77, clst:["b", "g", "b", "!"], meth:-1, pram:-1, actn:maxv, actc:niln)
                                ...
                                VStack {
                                    ...
                                    HStack {
                                        Color.clear.frame(width:1.0, height:1.0).contentShape(Rectangle()).overlay(ZStack {
                                            Circle().inset(by:-3.09).fill(colr(k:"z").opacity(0.93)).brightness(-0.39*1.09)
                                            butv(kind:"shuffle.circle", size:25.0, extr:[0.0, 0.0], iidx:3, clst:["b", "g", "b", "~"], meth:-1, pram:-1, actn:shfs, actc:shfz)
                                        ...
                                        Spacer()
                                        Color.clear.frame(width:1.0, height:1.0).contentShape(Rectangle())
                                    }.offset(y:0.99)
                                }.offset(y:0.99)
                            })
                        }.onContinuousHover { phase in
                                ...
                                HStack {
                                    Color.clear.frame(height:1.0).contentShape(Rectangle()).overlay(ZStack {
                                        ...
                                        VStack {
                                            HStack {
                                                Spacer()
                                                butv(kind:fsai(), size:26.0, extr:[epad*spcr, 0.0], iidx:27, clst:["b", "g", "b", "~"], meth:-1, pram:-1, actn:fsaa, actc:fsaz)
                                                butv(kind:fssi(), size:26.0, extr:[epad*spcr, 0.0], iidx:25, clst:["b", "g", "b", "~"], meth:-1, pram:-1, actn:fssa, actc:fssz)
                                            }.padding(.trailing, 1.0)
                                            Spacer()
                                        }.offset(x:-13.99, y:7.99)
                                    }.padding(.trailing, -11.0).frame(height:85.0).offset(x:3.00, y:19.00))

                                }.offset(x:-3.99, y:-1.99)
                            }
                            butv(kind:fswi(), size:30.0, extr:[0.0, 0.0], iidx:idxs[4], clst:["b", "g", "b", "~"], meth:-1, pram:-1, actn:fswa, actc:fswz).offset(x:12.0).overlay(
                                butv(kind:"multiply.circle", size:26.0, extr:[0.0, 0.0], iidx:5, clst:["b", "g", "b", "!"], meth:3, pram:1, actn:nill, actc:niln)
                                    .padding(.trailing, 1.0).padding(.top, 1.0).offset(x:13.00, y:41.00-offs)
                            )
                        }.frame(width:240.0).offset(x:0.09, y:-1.99+offs)
                        HStack {  }.overlay(
                            HStack {
                                ...
                                butv(kind:fsci(), size:26.0, extr:[epad*spcr, 0.0], iidx:8, clst:["b", "g", "b", "~"], meth:-1, pram:-1, actn:fsca, actc:fscz)
                                butv(kind:fsbi(), size:26.0, extr:[epad*spcr, 0.0], iidx:9, clst:["b", "g", "b", "~"], meth:-1, pram:-1, actn:fsba, actc:fsbz)
                                                        ...
                                                        HStack {
                                                            VStack {
                                                                ...
                                                                HStack {
                                                                    ...
                                                                    Text(" ")
                                                                    butv(kind:"multiply.circle", size:20.0, extr:[0.0, 0.0], iidx:91, clst:["b", "g", "b", "~"], meth:-1, pram:-1, actn:nilz, actc:nilc)
                                                                    Spacer()
                                                                }
                                                                Spacer()
